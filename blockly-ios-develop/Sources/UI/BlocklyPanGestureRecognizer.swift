...
//  //2017 05 20 tap辅助 开始点
//    open var startPoint : CGPoint = CGPoint(x:0, y:0);
//  // tap 辅助 对比点
//    open var changePoint : CGPoint = CGPoint(x:0, y:0);
...
//    NSLog("start x:%f y:%f",startPoint.x, startPoint.y);
  ...
  open override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent) {
    ...
    let moveTouch = touches.first;
    
    let changePoint = moveTouch?.location(in: moveTouch?.window);
...
//        }
//
//        if !(InsetTextField.isResponst(view: view!)) {
//            
//            return ;
//        }
//        
////        if view!.isKind(of: DefaultBlockView.self) {
////            
////            view!.perform(#selector(DefaultBlockView.tapAction(view:)), with: view);
////        } else {
////            
////            view = InsetTextField.searchTypeFor(view: view!);
////            
////            view!.perform(#selector(DefaultBlockView.tapAction(view:)), with: view);
////            
//////            view?.perform(#selector(InsetTextField.tapAction(view:)), with: view);
////        }
//        
//        
//       
