...
open class LayoutConfig: NSObject {
  ...
  public override init() {
    ...
    setColor(.white, for: LayoutConfig.FieldLabelTextColor)
    setColor(UIColor.init(red: 51/255.0, green: 51/255.0, blue: 51/255.0, alpha: 1), for: LayoutConfig.FieldEditableTextColor)

    setEdgeInsets(EdgeInsets(top: 4, leading: 10*_scale, bottom: 4, trailing: 10*_scale),
