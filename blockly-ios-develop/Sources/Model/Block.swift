...
public final class Block : NSObject {
    ...
    /// 2017 06 22 blockView 持有 为了高亮
    public weak var defaultBlockView: DefaultBlockView?;
        ...
        for input in self.inputs {
            ...
            for field in fields {
                ...
                if field.isMember(of: FieldImage.self) {
                    ...
                    let imageStr = String.init(format: "%@", imageField.imageLocation);
                    
                    values.append(imageStr);
                ...
                if field.isMember(of: FieldInput.self) {
                    ...
                    let str = try? inputField.serializedText();
